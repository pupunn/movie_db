...
<form action="?page=movie_save" method="post">
    <table class="table">
        ...
        <tr>
            <td>Deskripsi</td>
            <td>:</td>
            <td><textarea type="text" name="deskripsi" class="form-control"></textarea></td>
        </tr>
        <tr>
            <td>Genre</td> 
            <td>:</td>
            <td>
                <?php
                    ...
                    {
                        echo "<input type='checkbox' name='genre[]' class='form-check-input' value='".$row['id_genre']."'/> <label class='form-check-label'>".$row['nama_genre']."</label><br />";
                    }
                ?>
            </td>
        </tr>
